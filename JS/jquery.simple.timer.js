...
(function($){
  ...
  Timer.prototype.setFinalValue = function(finalValues, element) {
    ...
    element.find('.seconds').html(finalValues.pop() + '<span>ثانیه</span>');
    element.find('.minutes').html(finalValues.pop() + '<span>دقیقه</span>');
    element.find('.hours').html(finalValues.pop() + '<span>ساعت</span>');
  };
